...
_SKILLS: dict[str, dict] = {
    ...
    'documentation': {
        "description": 'See [docs](https://github.',
        "guidance": 'See [docs](https://github.com/scarletkc/vexor/tree/main/docs) for more details.',
    },
    'contributing': {
        "description": 'Contributions, issues, and PRs welcome! Star if you find it helpful.',
        "guidance": 'Contributions, issues, and PRs welcome! Star if you find it helpful.',
    },
    'star-history': {
        "description": '[![Star History Chart](https://api.',
        "guidance": '[![Star History Chart](https://api.star-history.com/svg?repos=scarletkc/vexor&type=date&legend=top-left)](https://www.star-history.com/#scarletkc/vexor&type=date&legend=top-left)',
    },
    'license': {
        "description": '[MIT](http://github.',
        "guidance": '[MIT](http://github.com/scarletkc/vexor/blob/main/LICENSE)',
    },
}


@mcp.tool()
def list_vexor_skills() -> dict:
    """List all available vexor skills."""
    return {k: v["description"] for k, v in _SKILLS.items()}


@mcp.tool()
def get_vexor_skill(skill_name: str = None) -> dict:
    """Get full guidance for a specific vexor skill."""
    ...
    hint = get_presentation_hint('vexor', client_id=client_id)
    if hint:
        skill_data = {**skill_data, "_presentation_hint": hint}
    return {
        "id": f"{skill_name}@vexor",
