"""Skill: industry_expert."""

from fastmcp import FastMCP
from core.skill_config import get_presentation_hint

mcp = FastMCP("industry-expert")


_SKILLS: dict[str, dict] = {
    'industry-expert': {
        "description": '|',
        "file": 'industry-expert.md',
    },
    'output': {
        "description": '|',
        "file": 'output.md',
...
@mcp.tool()
def list_industry_expert_skills() -> dict:
    """List all available industry_expert skills."""
    return {k: v["description"] for k, v in _SKILLS.items()}


@mcp.tool()
def get_industry_expert_skill(skill_name: str) -> dict:
    """Get full guidance for a specific industry_expert skill."""
    ...
    hint = get_presentation_hint('industry_expert')
    if hint:
