...
@mcp.tool()
def list_brave_skills() -> dict:
    """List all available brave skills."""
    return {k: v["description"] for k, v in _SKILLS.items()}


@mcp.tool()
def get_brave_skill(skill_name: str = None) -> dict:
    """Get full guidance for a specific brave skill."""
    ...
    hint = get_presentation_hint('brave', client_id=client_id)
    if hint:
        skill_data = {**skill_data, "_presentation_hint": hint}
    return {
        "id": f"{skill_name}@brave",
